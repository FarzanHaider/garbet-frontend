  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const registerData = {
        ...
        confirmPassword: formData.confirmPassword, // ✅ FIX
        currency: formData.currency,
        is18Plus: true,
        termsAccepted: formData.acceptTerms,
        kvkkAccepted: formData.acceptTerms,
        role: formData.role,
      ...
      // Save non-sensitive items locally (backend should set httpOnly cookie for token as well)
